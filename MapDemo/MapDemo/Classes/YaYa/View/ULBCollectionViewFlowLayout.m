...
//    }
    ...
    for (NSInteger section =0; section < sections; section++) {
        ...
        if (numberOfItems > 0) {
            ...
            if ([self.flowDelegate respondsToSelector:@selector(collectionView:layout:insetForSectionAtIndex:)]) {
                UIEdgeInsets inset = [self.flowDelegate collectionView:self.collectionView layout:self insetForSectionAtIndex:section];
            ...
            attr.zIndex = -1;
            attr.backgroudColor = [self.flowDelegate collectionView:self.collectionView layout:self colorForSectionAtIndex:section];
